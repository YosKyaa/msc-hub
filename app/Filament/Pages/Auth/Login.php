...
class Login extends BaseLogin
{
    ...
    protected function getGoogleButtonHtml(): string
    {
        ...
        return '
            <div style="background:linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%);border:2px solid #0ea5e9;border-radius:12px;padding:20px;margin-bottom:8px;">
                ...
                <a href="' . $url . '" 
                   ...
                   onmouseout="this.style.borderColor=\'#e5e7eb\';this.style.boxShadow=\'0 2px 8px rgba(0,0,0,0.08)\'">
                    <svg style="height:22px;width:22px;" viewBox="0 0 24 24">
